    ...
    textFilterWidget.prototype.renderWidget = function () {
        var html = '<div class="form-group">\
                    ...
                    <div class="grid-filter-buttons">\
                        <button type="button" class="btn btn-primary btn-sm grid-apply" >' + this.lang.applyFilterButtonText + '</button>\
                    </div>';
        ...
        var html = '<div class="form-group">\
                        ...
                        (this.datePickerIncluded ?
                            ...
                            '<div class="form-group">\
                             ...
                             <div class="grid-filter-buttons">\
                                <input type="button" class="btn btn-primary btn-sm grid-apply" value="' + this.lang.applyFilterButtonText + '" />\
                             </div>');
        this.container.append(html);
