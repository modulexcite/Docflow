...
namespace RapidDoc.Models.Services
{
    ...
    {
        IEnumerable<DepartmentTable> GetAll(string currentUserName = "");
        IEnumerable<DepartmentView> GetAllView();
        IEnumerable<DepartmentTable> GetPartial(Expression<Func<DepartmentTable, bool>> predicate, string currentUserName = "");
        ...
        void Delete(Guid id);
        DepartmentTable Find(Guid? id, string currentUserName = "");
    ...
    public class DepartmentService : IDepartmentService
    {
        ...
        public IEnumerable<DepartmentTable> GetAll(string currentUserName = "")
        {
        ...
        public IEnumerable<DepartmentTable> GetPartial(Expression<Func<DepartmentTable, bool>> predicate, string currentUserName = "")
        {
            string localUserName = getCurrentUserName(currentUserName);
            ApplicationUser user = _AccountService.FirstOrDefault(x => x.UserName == localUserName);
        ...
        public DepartmentTable Find(Guid? id, string currentUserName = "")
        {
            string localUserName = getCurrentUserName(currentUserName);
            ApplicationUser user = _AccountService.FirstOrDefault(x => x.UserName == localUserName);
